package com.example.tp_filmotheque.dal.mock;
...
public class DAOMovieMock implements IDAOMovie {
	...
	private static Long indexFilms = (long) 1;
	...
	public void simulationCoucheDALetDB() {
		...
		lstParticipants.add(new Participant((long) 1, "Spielberg", "Steven"));
		lstParticipants.add(new Participant((long)2, "Cronenberg", "David"));
		lstParticipants.add(new Participant((long)3, "Boon", "Dany"));

		// 2 acteurs par film et l'un d'eux dans 2 films
		lstParticipants.add(new Participant((long)4, "Attenborough", "Richard"));
		lstParticipants.add(new Participant((long)5, "Goldblum", "Jeff"));
		lstParticipants.add(new Participant((long)6, "Davis", "Geena"));
		lstParticipants.add(new Participant((long)7, "Rylance", "Mark"));
		lstParticipants.add(new Participant((long)8, "Barnhill", "Ruby"));
		lstParticipants.add(new Participant((long)9, "Merad", "Kad"));
		...
		Membre membre1 = new Membre((long) 1, "Baille", "Anne-Lise", "abaille@campus-eni.fr", null, null);
		Avis avis = new Avis((long)1, 4, "On rit du début à la fin", membre1);
